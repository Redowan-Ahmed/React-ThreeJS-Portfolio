    ...
    <li className=" mb-1 border-b border-gray-600 space-y-2 select-text">
      {editing ? (
        ...
        <div className=" flex items-center justify-between p-4 px-3">
          <div className=" flex items-center space-x-3 w-11/12">
            <input
              type="checkbox"
            ...
            />
          <div className="flex justify-between md:w-full md:items-center flex-col items-start md:flex-row">
            <span
              className={` ${
                task.completed
            ...
            <div className="flex gap-3" title="Date Time ">
            <span
              className={` ${
                task.completed
